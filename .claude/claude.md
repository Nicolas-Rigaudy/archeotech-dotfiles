...
**Next Sprint:** Sprint 24 depth follow-ups (the IA restructure shipped 2026-06-11; the original "depth" tasks remain): Connections WiFi/BT sub-tabs, Audio sources/aliasing, ColorScheme pane (dark-mode/schedule/extraction), settings fuzzy search, Layout pane. Also pending: Sprint 21 Chunk 3 — desktop widget layer on `WlrLayer.Bottom` + peek-desktop access.
