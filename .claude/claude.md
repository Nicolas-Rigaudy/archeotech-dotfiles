...
**Next Sprint:** Sprint 23 — Lock Screen (native QML `WlSessionLock` + `PamContext`, replaces swaylock). Also pending: Sprint 21 Chunk 3 — desktop widget layer on `WlrLayer.Bottom` + peek-desktop access.
