# Archeotech — Project History & Full Knowledge Base (archived)

_This is the full pre-2026-08-21 `.claude/claude.md`, preserved verbatim when that file was restructured into a lean instructions file. It holds the shipped-implementation log, the session-by-session changelog, detailed component tables, operational how-tos, and the locked shell-architecture prose. Current instructions live in `.claude/claude.md`; planning lives in `logics/`._
