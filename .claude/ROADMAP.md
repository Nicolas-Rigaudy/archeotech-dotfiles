...
- **`zen.theme.accent-color` pref** — tried 2026-07-01 (set in profile user.js); [RESULT TBD]. Cheapest lever; if Zen honors it, theme-switch writes it per-theme for a palette-driven accent (separate from the gradient background).
