...
# Plan
- [ ] Use `python3 -m logics_manager flow progress task task_007_dual_sddm_session_entry_hyprctl_reload_parity_remaining.md --progress <n>%` during multi-wave work.
- [ ] Run `python3 -m logics_manager flow finish task task_007_dual_sddm_session_entry_hyprctl_reload_parity_remaining.md` after implementation.
